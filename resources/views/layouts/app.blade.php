...
<head>
  ...
  <title>@yield('title', 'シフト管理') - 業務ポータル</title>
  ...
  <style>
    ...
    .sidebar { width:220px; min-height:100vh; background:#1e293b; position:fixed; top:0; left:0; z-index:100; display:flex; flex-direction:column; }
    ...
    .nav-link { color:rgba(255,255,255,.7); border-radius:8px; margin:2px 8px; padding:.55rem .85rem; font-size:.875rem; display:flex; align-items:center; gap:.55rem; transition:background .15s,color .15s; }
    ...
    .nav-section { font-size:.7rem; color:rgba(255,255,255,.35); padding:.75rem 1.25rem .25rem; text-transform:uppercase; letter-spacing:.05em; }
...
<body>
<div class="sidebar">
  <div class="sidebar-brand"><i class="bi bi-grid-3x3-gap me-2"></i>業務<span>ポータル</span></div>
  <nav class="mt-2 flex-grow-1">
    <div class="nav-section">シフト管理</div>
    <a href="{{ route('shift.dashboard') }}" class="nav-link @yield('nav_dashboard')">
